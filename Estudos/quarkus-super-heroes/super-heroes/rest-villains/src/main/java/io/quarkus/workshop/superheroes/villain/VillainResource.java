...
public class VillainResource {
    ...
    @APIResponse(
        responseCode = "200",
        description = "The atualizado villain",
    ...
    @DELETE
    @Path("/{id}")
    @APIResponse(responseCode = "204", description = "The villain is deleted")
    @APIResponse(responseCode = "200", description = "The villain is not found for a given identifier")
